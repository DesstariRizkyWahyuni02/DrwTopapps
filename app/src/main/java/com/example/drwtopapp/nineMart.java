...
public class nineMart extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")){
                String nomortel ="tel:0822-8547-8182";
            ...
            }else if (pilihan.equals("SMS Center"))
            {
                ...
                {
                    String lokasimart = " https://g.co/kgs/QThkB9";
                a = new Intent(Intent.ACTION_VIEW,Uri.parse(lokasimart));
            }else if (pilihan.equals("Info di Google"))
            {
                a = new Intent(Intent.ACTION_WEB_SEARCH);
                a.putExtra(SearchManager.QUERY,"999 Mart");
